...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(text="☁️ ᴄᴏ-ᴅᴇᴠ ☁️", url=f"tg://user?id=7355202884"
    ],
]
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_sticker(
                "CAACAgQAAyEFAASLR3hBAAM_ZuZ1By9Z_2m__cgTKsVsEfAimN0AAmgYAAL1bbhQ0gokGH3TRlYeBA"
            )
...
*ʜᴇʀᴇ ɪs ᴍʏ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ :* [ᴄʟɪᴄᴋ ʜᴇʀᴇ](https://t.me/LeafSecurityContributers)
